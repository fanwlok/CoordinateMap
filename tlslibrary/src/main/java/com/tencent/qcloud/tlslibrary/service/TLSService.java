...
//        accountHelper.setTestHost("113.108.64.238", false);    // 不走sso
    ...
    public void initPhonePwdRegisterService(Context context,
                                            ...
                                            Button btn_requireCheckCode,
                                            Button btn_verify) {
        phonePwdRegisterService = new PhonePwdRegisterService(context, txt_countryCode, txt_phoneNumber, txt_checkCode,txt_password,txt_password1 ,btn_requireCheckCode, btn_verify);
    }
    ...
    public void initResetPhonePwdService(Context context,
                                            ...
                                            Button btn_requireCheckCode,
                                            Button btn_verify) {
        resetPhonePwdService = new ResetPhonePwdService(context, txt_countryCode, txt_phoneNumber, txt_checkCode, txt_password,btn_requireCheckCode, btn_verify);
    }
