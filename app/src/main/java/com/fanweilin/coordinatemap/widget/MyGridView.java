...
public class MyGridView extends GridView {
    ...
    private void init(AttributeSet attrs) {
        ...
        TypedArray ta = getContext().obtainStyledAttributes(attrs, R.styleable.MyGridView);
        width = ta.getDimensionPixelSize(R.styleable.MyGridView_dividerWidth, 1);
        color = ta.getColor(R.styleable.MyGridView_dividerColor, Color.BLACK);
        showButtonLine = ta.getBoolean(R.styleable.MyGridView_showButtonLine, true);
        showTopLine = ta.getBoolean(R.styleable.MyGridView_showTopLine,true);
        inScrollView = ta.getBoolean(R.styleable.MyGridView_inScrollView, false);
        ta.recycle();
    }
