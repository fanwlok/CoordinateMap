...
public class GpsSkyFragment extends Fragment implements GpsTestListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate( 
                R.layout.gps_sky, container,false);
    ...
    private void updateSnrCn0Avgs() {
        ...
        if (MathUtils.isValidFloat(mSkyView.getSnrCn0InViewAvg())) {
            ...
            leftInViewTextViewMarginPx = UIUtils.dpToPixels(data.getContext(), leftInViewTextViewMarginDp);
        ...
        if (MathUtils.isValidFloat(mSkyView.getSnrCn0UsedAvg())) {
            ...
            leftUsedTextViewMarginPx = UIUtils.dpToPixels(data.get(), leftUsedTextViewMarginDp);
        }
        ...
        if (leftInViewTextViewMarginPx != null && leftUsedTextViewMarginPx != null) {
            int offset = UIUtils.dpToPixels(data.get(), -14);
        ...
        int pSides = UIUtils.dpToPixels(data.get(), 7);
        int pTopBottom = UIUtils.dpToPixels(data.get(), 4);
        ...
        if (MathUtils.isValidFloat(mSkyView.getSnrCn0InViewAvg())) {
            ...
            LayerDrawable background = (LayerDrawable) ContextCompat.getDrawable(data.get(), R.drawable.cn0_round_corner_background_in_view);
            ...
            int leftIndicatorMarginPx = UIUtils.dpToPixels(data.get(), leftIndicatorMarginDp);
        ...
        if (MathUtils.isValidFloat(mSkyView.getSnrCn0UsedAvg())) {
            ...
            LayerDrawable background = (LayerDrawable) ContextCompat.getDrawable(data.get(), R.drawable.cn0_round_corner_background_used);
            ...
            int leftMarginPx = UIUtils.dpToPixels(data.get(), leftMarginDp);
