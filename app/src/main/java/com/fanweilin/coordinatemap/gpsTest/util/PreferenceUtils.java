...
public class PreferenceUtils {
    ...
    public static void saveString(String key, String value) {
        saveString(data.getPrefs(), key, value);
    }
    ...
    public static void saveInt(String key, int value) {
        saveInt(data.getPrefs(), key, value);
    }
    ...
    public static void saveLong(String key, long value) {
        saveLong(data.getPrefs(), key, value);
    }
    ...
    public static void saveBoolean(String key, boolean value) {
        saveBoolean(data.getPrefs(), key, value);
    }
    ...
    public static void saveFloat(String key, float value) {
        saveFloat(data.getPrefs(), key, value);
    }
    ...
    public static void saveDouble(String key, double value) {
        saveDouble(data.getPrefs(), key, value);
    }
    ...
    public static Double getDouble(String key, double defaultValue) {
        if (!data.getPrefs().contains(key)) {
            return defaultValue;
        }
        return Double.longBitsToDouble(data.getPrefs().getLong(key, 0));
    }

    public static String getString(String key) {
        return data.getPrefs().getString(key, null);
    }

    public static long getLong(String key, long defaultValue) {
        return data.getPrefs().getLong(key, defaultValue);
    }

    public static float getFloat(String key, float defaultValue) {
        return data.getPrefs().getFloat(key, defaultValue);
    }
}
