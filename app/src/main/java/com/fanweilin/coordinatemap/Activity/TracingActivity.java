...
import com.fanweilin.coordinatemap.Trace.model.CurrentLocation;
import com.fanweilin.coordinatemap.Trace.receiver.TrackReceiver;
import com.fanweilin.coordinatemap.Trace.utils.BitmapUtil;
import com.fanweilin.coordinatemap.Trace.utils.CommonUtil;
import com.fanweilin.coordinatemap.Trace.utils.Constants;
import com.fanweilin.coordinatemap.Trace.utils.MapUtil;
import com.fanweilin.coordinatemap.Trace.utils.ViewUtil;

public class TracingActivity extends AppCompatActivity implements View.OnClickListener {

    private data trackApp = null;
    ...
    private void init() {
        initListener();
        trackApp = (data) getApplicationContext();
    ...
    private void setTraceBtnStyle() {
        ...
        if (isTraceStarted) {
            ...
            traceBtn.setTextColor(ResourcesCompat.getColor(getResources(), R.color.panel_black, null));
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.JELLY_BEAN) {
                traceBtn.setBackground(ResourcesCompat.getDrawable(getResources(),
    ...
    private void setGatherBtnStyle() {
        ...
        if (isGatherStarted) {
            ...
            gatherBtn.setTextColor(ResourcesCompat.getColor(getResources(), R.color.panel_black, null));
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.JELLY_BEAN) {
                gatherBtn.setBackground(ResourcesCompat.getDrawable(getResources(),
                        R.mipmap.bg_btn_cancel, null));
            } else {
            ...
            public void onPushCallback(byte messageType, PushMessage pushMessage) {
                ...
                if (Build.VERSION.SDK_INT > Build.VERSION_CODES.JELLY_BEAN) {
                    Notification notification = new Notification.Builder(trackApp)
                            ...
                            .setSmallIcon(R.mipmap.earth_globe_48px)
