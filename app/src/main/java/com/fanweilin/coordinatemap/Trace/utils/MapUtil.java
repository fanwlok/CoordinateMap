package com.fanweilin.coordinatemap.Trace.utils;
...
import static com.fanweilin.coordinatemap.Trace.utils.BitmapUtil.bmArrowPoint;
import static com.fanweilin.coordinatemap.Trace.utils.BitmapUtil.bmEnd;
import static com.fanweilin.coordinatemap.Trace.utils.BitmapUtil.bmStart;
...
public class MapUtil {
     ...
     * @param trackApp
     */
    public void setCenter(data trackApp) {
    ...
    public void updateStatus(LatLng currentPoint, boolean showMarker) {
        ...
        if (null != baiduMap.getProjection()) {
            ...
            if (screenPoint.y < 200 || screenPoint.y > data.screenHeight - 500
                    || screenPoint.x < 200 || screenPoint.x > data.screenWidth - 200
                    || null == mapStatus) {
