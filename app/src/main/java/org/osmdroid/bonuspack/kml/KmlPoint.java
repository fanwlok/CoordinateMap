...
public class KmlPoint extends KmlGeometry implements Parcelable, Cloneable {
	...
	/*	Marker marker = new Marker(map);
		...
		pointData.setName(kmlPlacemark.mName);
		pointData.setDescribe(kmlPlacemark.mDescription);
		pointData.setWgslatitude(String.valueOf(getPosition().getLatitude()));
		pointData.setWgslongitude(String.valueOf(getPosition().getLongitude()));
		pointData.setAltitude(String.valueOf(getPosition().getAltitude()));
