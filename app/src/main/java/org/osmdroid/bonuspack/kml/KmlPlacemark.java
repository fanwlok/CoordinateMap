...
public class KmlPlacemark extends KmlFeature implements Cloneable, Parcelable {
	...
	@Override public void buildOverlay(Files files,  Styler styler, KmlDocument kmlDocument){
	/*	if (mGeometry != null)
			return mGeometry.buildOverlay(map, styler, this, kmlDocument);
		else 
			return null;*/
		if(mGeometry!=null){
			mGeometry.buildOverlay(files,styler,this,kmlDocument);
		}
	}
