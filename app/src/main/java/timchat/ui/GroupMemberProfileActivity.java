...
import timchat.model.GroupMemberProfile;
...
public class GroupMemberProfileActivity extends FragmentActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        TemplateTitle title = findViewById(R.id.GroupMemTitle);
    ...
    private boolean canManage(){
        return (currentUserRole == TIMGroupMemberRoleType.Owner && profile.getRole() != TIMGroupMemberRoleType.Owner) ||
