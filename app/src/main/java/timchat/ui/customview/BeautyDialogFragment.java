...
public class BeautyDialogFragment extends DialogFragment implements SeekBar.OnSeekBarChangeListener {
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        mBeautySeekbar = dialog.findViewById(R.id.beauty_seekbar);
        ...
        mWhitenSeekbar = dialog.findViewById(R.id.whiten_seekbar);
        ...
        mFaceLiftSeekbar = dialog.findViewById(R.id.facelift_seekbar);
