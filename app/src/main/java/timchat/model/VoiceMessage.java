...
public class VoiceMessage extends Message {
    ...
    public void showMessage(ChatAdapter.ViewHolder viewHolder, Context context) {
        ...
        LinearLayout linearLayout = new LinearLayout(data.getContext());
        linearLayout.setOrientation(LinearLayout.HORIZONTAL);
        linearLayout.setGravity(Gravity.CENTER);
        ImageView voiceIcon = new ImageView(data.getContext());
        ...
        TextView tv = new TextView(data.getContext());
        tv.setTextSize(TypedValue.COMPLEX_UNIT_SP, 18);
        tv.setTextColor(data.getContext().getResources().getColor(isSelf() ? R.color.white : R.color.black));
    ...
    public String getSummary() {
        ...
        return data.getContext().getString(R.string.summary_voice);
    }
