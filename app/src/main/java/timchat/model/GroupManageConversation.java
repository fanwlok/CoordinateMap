...
public class GroupManageConversation extends Conversation {
    ...
    public String getLastMessageSummary() {
        ...
        switch (lastMessage.getPendencyType()){
            case INVITED_BY_OTHER:
                if (isSelf){
                    return data.getContext().getResources().getString(R.string.summary_me)+
                            data.getContext().getResources().getString(R.string.summary_group_invite)+
                            to+
                            data.getContext().getResources().getString(R.string.summary_group_add);
                }else{
                    if (to.equals(UserInfo.getInstance().getId())){
                        return from+
                                data.getContext().getResources().getString(R.string.summary_group_invite)+
                                data.getContext().getResources().getString(R.string.summary_me)+
                                data.getContext().getResources().getString(R.string.summary_group_add);
                    }else{
                        return from+
                                data.getContext().getResources().getString(R.string.summary_group_invite)+
            ...
            case APPLY_BY_SELF:
                if (isSelf){
                    return data.getContext().getResources().getString(R.string.summary_me)+
                            data.getContext().getResources().getString(R.string.summary_group_apply)+
                            GroupInfo.getInstance().getGroupName(lastMessage.getGroupId());
                }else{
                    return from+data.getContext().getResources().getString(R.string.summary_group_apply)+GroupInfo.getInstance().getGroupName(lastMessage.getGroupId());
                }
    ...
    public String getName() {
        return data.getContext().getString(R.string.conversation_system_group);
    }
