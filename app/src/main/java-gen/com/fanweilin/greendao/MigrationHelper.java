...
public class MigrationHelper {
     ...
     *  MigrationHelper.migrate((SQLiteDatabase)db.getRawDatabase(),FilesDao.class,PointDataDao.class,ShowDataDao.class,PictureDataDao.class);
     */
    ...
    private static void dropAllTables(SQLiteDatabase db, boolean ifExists, @NonNull Class<? extends AbstractDao<?, ?>>... daoClasses) {
        reflectMethod(new StandardDatabase(db), "dropTable", ifExists, daoClasses);
    }
    ...
    private static void createAllTables(SQLiteDatabase db, boolean ifNotExists, @NonNull Class<? extends AbstractDao<?, ?>>... daoClasses) {
        reflectMethod(new StandardDatabase(db), "createTable", ifNotExists, daoClasses);
    }
 ...
 /*MigrationHelper.migrate((SQLiteDatabase)db.getRawDatabase(),FilesDao.class,PointDataDao.class,CoordinateDataDao.class,SqlpointDao.class,SqlPolygonDao.class
                    ,SqlPolylineDao.class,PictureDataDao.class,OlfilesDao.class);
        ShowDataDao.dropTable(db, true);
        ShowDataDao.createTable(db,false);*/
/*
    MigrationHelper.migrate((SQLiteDatabase)db.getRawDatabase(),FilesDao.class,PointDataDao.class,CoordinateDataDao.class,SqlpointDao.class,SqlPolygonDao.class
                    ,SqlPolylineDao.class,PictureDataDao.class,OlfilesDao.class);
        ShowDataDao.dropTable(db, true);
